...
# the source files
SRCS=main.cpp FatalException.cpp snake.cpp board.cpp cmdlineargs.c draw.c highscore.cpp highscoreTest.c mlog.c position.c protocol.c segment.cpp testing.c
